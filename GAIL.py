...
class GAIL(nn.Module):
    def __init__(self, writer, device, state_dim, action_dim, args):
        ...
        self.device = device
        self.args = args
        self.network = Network(args.layer_num, state_dim, 1, args.hidden_dim, args.activation_function,args.last_activation)
    ...
    def train_network(self,writer,n_epi,agent_s,agent_a,expert_s):
        expert_cat = torch.tensor(expert_s)
